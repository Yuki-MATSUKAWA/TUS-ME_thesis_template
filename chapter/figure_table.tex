...
次に表のセル結合について説明します．
行方向のセル結合を行う際は \verb|\multicolumn{結合する列数}{揃え位置}{セルの中身}| を使います．
...
面白い使い方ですね．
列方向のセル結合を行う際は \verb|\multirow{結合する行数}{幅}{セルの中身}| を使います．
...
やりがちなミスとして，負の数をセルに入れるときに数式環境 \verb|$$| に入れ忘れて，マイナスがハイフンとなって出力されているものがあります．
