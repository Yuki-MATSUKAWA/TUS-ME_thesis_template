...
パネル (\subref{subfig:figcomp2_pdf}) はカラーマップだけラスターとし，文字情報は全てベクターで抽出できるようになっています（ファイル自体は PDF）．
(\subref{subfig:figcomp2_png}) は全てラスター（PNG）の画像です．
...
\begin{table}
    ...
    \begin{tabular}{l|c|r} \hline\hline
        ...
        日本架空学会    & 名誉学生会員  & $6.02 \times 10^{23}$ 円 \\ \hline
    \end{tabular}
\end{table}
